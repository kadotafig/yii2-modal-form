 ...
 */
namespace kadotafig\modal;

use yii\base\Widget;
use yii\helpers\ArrayHelper;
use kadotafig\modal\ModalFormAsset;
use kadotafig\modal\ModalFormAsset4;
...
class ModalForm extends Widget
{
    ...
    public function init()
    {
        ...
        $assetClassName = 'kadotafig\modal\ModalFormAsset'.$this->_bsVersion;
